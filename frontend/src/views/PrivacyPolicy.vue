<template>
  <div class="privacy">
    ...
    <div class="privacy-box rounded-lg">
      ...
      <div class="privacy-body-wrapper">
        <div class="privacy-body">
          <strong class="privacy-body-title">第1条（個人情報）</strong>
        ...
        <div class="privacy-body">
          <strong class="privacy-body-title"
            >第2条（個人情報の収集方法）</strong
          >
          <div class="privacy-body-content">
            本サービスは、ユーザーが利用登録をする際に氏名、生年月日、住所、電話番号、メールアドレス、職業などの個人情報をお尋ねすることがあります。
          </div>
        </div>

        <div class="privacy-body">
          <strong class="privacy-body-title"
            >第3条（個人情報を収集・利用する目的）</strong
          >
          <div class="privacy-body-content">
        ...
        <div class="privacy-body">
          <strong class="privacy-body-title">第4条（利用目的の変更）</strong>
          <div class="privacy-body-content">
            <ul>
              <li>
        ...
        <div class="privacy-body">
          <strong class="privacy-body-title">第6条（個人情報の開示）</strong>
          <div class="privacy-body-content">
            <ul>
              <li>
        ...
        <div class="privacy-body">
          <strong class="privacy-body-title">第10条（お問い合わせ窓口）</strong>
          <div class="privacy-body-content">
            本ポリシーに関するお問い合わせは、下記の窓口までお願いいたします。
            <div>Eメールアドレス：<a href="mailto:daiki.work.0118@gmail.com">daiki.work.0118@gmail.com</a></div>
          </div>
        </div>
      </div>
    </div>
